	...
	<div class="col-md-12 column">
		<form class="navbar-form navbar-left" role="search">
			<div class="form-group">
				<span class="search-span"> 销售退货日期:</span> 
		...
		if(flag){
			...
			$.ajax({
				...
				data:"sales.date=" + date + "&sales.customer.id=" + customerId 
					+ "&sales.operator.id=" + operatorId +"&sales.count=" + count +"&sales.xtFlag=1",
				dataType:"text",
				success:function(data){
					salesId = data;
					salAndProAdd();
					alert("保存成功！");
					location.href="salesManage?sales.xtFlag=1";
				}
			});
